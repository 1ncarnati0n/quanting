...
export const COLORS = {
  ...
  rvolHigh: "rgba(34,197,94,0.65)",
  rvolLow: "rgba(239,68,68,0.45)",
  rvolNeutral: "rgba(148,163,184,0.45)",
  // Quant Signal Strategies
  supertrendBuy: "#10B981",
  supertrendSell: "#F43F5E",
  emaCrossoverBuy: "#0EA5E9",
  emaCrossoverSell: "#F97316",
  stochRsiBuy: "#06B6D4",
  stochRsiSell: "#EC4899",
  cmfObvBuy: "#34D399",
  cmfObvSell: "#FB7185",
  ttmSqueezeBuy: "#8B5CF6",
  ttmSqueezeSell: "#D946EF",
  vwapBreakoutBuy: "#14B8A6",
  vwapBreakoutSell: "#E11D48",
  parabolicSarBuy: "#A3E635",
  parabolicSarSell: "#F87171",
  macdHistReversalBuy: "#6366F1",
  macdHistReversalSell: "#FB923C",
  ibsMeanRevBuy: "#22D3EE",
  ibsMeanRevSell: "#F472B6",
  rsiDivergenceBuy: "#818CF8",
  rsiDivergenceSell: "#FCA5A5",
} as const;
...
export const INDICATOR_DEFAULTS = {
  ...
  signalStrategies: {
    supertrendAdx: false,
    emaCrossover: false,
    stochRsiCombined: false,
    cmfObv: false,
    ttmSqueeze: false,
    vwapBreakout: false,
    parabolicSar: false,
    macdHistReversal: false,
    ibsMeanReversion: false,
    rsiDivergence: false,
    emaFastPeriod: 9,
    emaSlowPeriod: 21,
    divergenceSwingLength: 5,
  },
} as const;
...
export const PRESET_CATEGORIES: PresetCategory[] = [
  {
    ...
    items: [
      ...
      { symbol: "INTC", label: "Intel", market: "usStock" },
      { symbol: "KO", label: "Coca-Cola", market: "usStock" },
      { symbol: "PEP", label: "PepsiCo", market: "usStock" },
      { symbol: "XOM", label: "ExxonMobil", market: "usStock" },
      { symbol: "CVX", label: "Chevron", market: "usStock" },
      { symbol: "BAC", label: "Bank of America", market: "usStock" },
      { symbol: "NFLX", label: "Netflix", market: "usStock" },
      { symbol: "COIN", label: "Coinbase", market: "usStock" },
      { symbol: "PLTR", label: "Palantir", market: "usStock" },
      { symbol: "BABA", label: "Alibaba", market: "usStock" },
    ],
  },
  {
    name: "미국 ETF",
    ...
    items: [
      ...
      { symbol: "VEU", label: "Vanguard FTSE All-World ex-US", market: "usStock" },
      { symbol: "AGG", label: "iShares Core US Agg Bond", market: "usStock" },
      { symbol: "BIL", label: "SPDR 1-3 Month T-Bill", market: "usStock" },
      { symbol: "EFA", label: "iShares MSCI EAFE", market: "usStock" },
      { symbol: "IEF", label: "iShares 7-10Y Treasury", market: "usStock" },
      { symbol: "VNQ", label: "Vanguard Real Estate", market: "usStock" },
    ],
  },
  {
    name: "미국 섹터 ETF",
    market: "usStock",
    items: [
      { symbol: "XLV", label: "Health Care", market: "usStock" },
      { symbol: "XLY", label: "Consumer Discretionary", market: "usStock" },
      { symbol: "XLI", label: "Industrials", market: "usStock" },
      { symbol: "XLU", label: "Utilities", market: "usStock" },
      { symbol: "XLRE", label: "Real Estate", market: "usStock" },
      { symbol: "XLB", label: "Materials", market: "usStock" },
      { symbol: "XLC", label: "Communication Services", market: "usStock" },
      { symbol: "XLP", label: "Consumer Staples", market: "usStock" },
    ],
  },
  {
    name: "미국 고변동주",
    market: "usStock",
    items: [
      { symbol: "MARA", label: "Marathon Digital", market: "usStock" },
      { symbol: "RIOT", label: "Riot Platforms", market: "usStock" },
      { symbol: "SOFI", label: "SoFi Technologies", market: "usStock" },
      { symbol: "NIO", label: "NIO Inc", market: "usStock" },
    ],
  },
  {
    name: "한국 대형주",
    ...
    items: [
      ...
      { symbol: "000270.KS", label: "기아", market: "krStock" },
      { symbol: "055550.KS", label: "신한지주", market: "krStock" },
      { symbol: "017670.KS", label: "SK텔레콤", market: "krStock" },
      { symbol: "030200.KS", label: "KT", market: "krStock" },
    ],
  },
  {
    name: "한국 ETF",
